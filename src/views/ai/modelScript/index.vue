...
const handleExport = () => {
  ...
  proxy
      .download('/front/modelScript/export', { ...queryParams.value }, '模型预设脚本数据')
      .finally(() => {
    ...
    <a-card class="general-card" :title="$t('menu.ai.modelScript.list')">
        ...
        <div class="header-operation">
          <a-row>
            <a-col :span="12">
              <a-space>
                <a-button
                    v-permission="['front:modelScript:add']"
                    type="primary"
                    @click="toAdd"
                >
                ...
                <a-button
                    v-permission="['front:modelScript:update']"
                    type="primary"
                    status="success"
                    :disabled="single"
                ...
                <a-button
                    v-permission="['front:modelScript:export']"
      ...
      >
        <template #columns>
          ...
          <a-table-column title="状态（1：启用；2：禁用）" data-index="status" />
          <a-table-column title="创建人" data-index="createUser" />
          <a-table-column title="创建时间" data-index="createTime" />
          <a-table-column
              v-if="checkPermission(['front:modelScript:update', 'front:modelScript:delete'])"
              title="操作"
              align="center"
          >
            <template #cell="{ record }">
      ...
      >
        <a-form ref="formRef" :model="form" :rules="rules" size="large">
          ...
          <a-form-item label="状态（1：启用；2：禁用）" field="status">
            <a-input v-model="form.status" placeholder="请输入状态（1：启用；2：禁用）" />
          </a-form-item>
        </a-form>
      </a-modal>
      ...
      >
        <a-descriptions :column="2" bordered size="large">
          ...
          <a-descriptions-item label="组件路径">
            ...
            <span v-else>{{ dataDetail.component }}</span>
          </a-descriptions-item>
